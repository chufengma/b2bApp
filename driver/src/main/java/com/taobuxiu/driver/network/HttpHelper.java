package com.taobuxiu.driver.network;

import android.accounts.NetworkErrorException;
import android.os.Build;

import com.orhanobut.logger.Logger;
import com.taobuxiu.driver.BuildConfig;
...
import com.taobuxiu.driver.network.persistentcookiejar.ClearableCookieJar;
import com.taobuxiu.driver.network.persistentcookiejar.PersistentCookieJar;
import com.taobuxiu.driver.network.persistentcookiejar.cache.SetCookieCache;
import com.taobuxiu.driver.network.persistentcookiejar.persistence.SharedPrefsCookiePersistor;
...
public class HttpHelper {
    ...
    public static final String BASE_URL = "http://10.32.24.13:5389/";
    ...
    public abstract static class NetworkSubscriber<T extends BaseResponse> extends Subscriber<T> {
        ...
        public void onNext(T t) {
            if (t.status == 0) {
                ...
                SPHelper.top().save(Constant.StorageKeys.DRIVER_PROFILE, "");
