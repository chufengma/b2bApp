...
import static com.taobuxiu.driver.model.Constant.StorageKeys.GET_VERIFY_CODE_TIME;
...
public class CountDownTextView extends TextView {
    ...
    private void init() {
        ...
        long lastGetVerifyCodeTime = SPHelper.top().getLong(GET_VERIFY_CODE_TIME, 0);
    ...
    public void onGetCode(OnGetMsgCodeEvent event) {
        if (event.status == BaseListStatusEvent.STARTED) {
            ...
            SPHelper.top().save(GET_VERIFY_CODE_TIME, System.currentTimeMillis());
            startCountDown(0);
        }
    }
